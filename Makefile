...
SRCS= src/main.cpp src/JSInput.cpp src/JSDraw.cpp src/JSSys.cpp src/JSFS.cpp src/JSDatabase.cpp src/JSMod.cpp src/Database.cpp src/Filesystem.cpp src/extern/GLFT_Font.cpp src/GL3Buffer.cpp src/Shader.cpp src/EngineUI.cpp src/Draw2D.cpp src/Logger.cpp src/Profiler.cpp src/ResourceManager.cpp src/Config.cpp src/LogGraphEvents.cpp src/Util.cpp src/PlatformOSX.cpp src/Events.cpp src/TestSuite.cpp src/Application.cpp src/PlatformTests.cpp
